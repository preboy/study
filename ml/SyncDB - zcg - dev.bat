...
mysqldump.exe --set-gtid-purged=off -h172.31.248.17 -udev -pdev -d dev_world > dev_world.sql
mysql -h127.0.0.1 -udev -pdev dev_world < dev_world.sql

echo sync dev_uname_____________________
mysqldump.exe --set-gtid-purged=off -h172.31.248.17 -udev -pdev -d dev_uname > dev_uname.sql
mysql -h127.0.0.1 -udev -pdev dev_uname < dev_uname.sql

echo sync dev_log_____________________
mysqldump.exe --set-gtid-purged=off -h172.31.248.17 -udev -pdev -d dev_log > dev_log.sql
